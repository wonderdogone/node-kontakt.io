...
function KontaktApi(key) {
  ...
  (!(this instanceof KontaktApi)) return new KontaktApi(key);
}
...
KontaktApi.prototype.getBeacon = function(resource, callback) {
  var beaconId, resource, endpoint, managerId, credentials, contact, options, byUnique, proximity,
  ...
  if (resource != null) {
    ...
    options = { uri: p,
      json: true,
      headers: {
        'Accept' : 'application/vnd.com.kontakt+json; version=3',
